		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#salesorderupdate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"salesorderupdate-display": {
								"semanticObject": "salesorderupdate",
								"action": "display",
								"description": "Sales Order Update",
								"title": "Sales Order Update",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=salesorderupdate",
									"url": sap.ui.require.toUrl("salesorderupdate")
								}
							}
						}
					}
